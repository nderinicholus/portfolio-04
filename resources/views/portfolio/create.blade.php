    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="border-bottom mb-3">
                <h2 class="pt-3 text-muted">Create a Portfolio page</h2>
                <span class="small"><a href="{{ route('portfolio.index') }}">Portfolio</a> > Create a project</span>
            </div>
            <div class="card">
                <div class="card-header inline-flex">{{ __('Projects') }}
